    ...
    <div className="DocumentationContainer">
      <div className="row justify-content-center">
        ...
        <div className="col-11">
          ...
          <p>
            The current smart contracts are written in the Go scripting language. Function names relate to specific
            terms or schemes of the contract, and often structured as ‘if, then’ statements. Contract descriptions in
            plain english are provided in grey letter prior to each function.<br/><br/>
            To perform a careful revision of smart contracts, you need a certified smart contract auditor. This
            project’s have been audited and approved by all parties.
          </p>
        </div>
      </div>
    </div>
