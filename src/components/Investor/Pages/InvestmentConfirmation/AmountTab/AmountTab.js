...
const AmountTab = props => (
  <div className="invesc-confirm-amount">
    ...
    <div className="invest-confirm-header">Deine your investment amount</div>
    ...
    <div className="invest-confirm-wrapper">
      ...
      <div className="col-8 invest-confirm-value total">$ {props.investmentValue.toFixed(1)}</div>
    </div>
    <div className="col-12 solar-form-separator" />
    <div className="invest-confirm-wrapper">
      <div className="col-4 invest-confirm-text">Your available balance:</div>
