...
configureAnchors({offset: -90, scrollDuration: 200, keepLastAnchorHash: true});
          ...
          <div className="row">
            ...
            <div className="col-12 text-description">
              ...
              <div className="sub-text">
                Proceeds from this project's raise are invested in the
                development of a Proof-of-Concept installation in the Segunda
                Unidad Pasto School in Aibonito, Puerto Rico. The PoC is part of
                research initiative of the Yale OpenLab and the Digital Currency
                Initiative of the MIT Media Lab.
              </div>
            </div>
            ...
            <div className="col-12 security-note">
              ...
              <div className="security-text">
                ...
                in convallis feugiat. Sed vulputate fringilla felis. Link >
              </div>
            </div>
          </div>
        </div>
