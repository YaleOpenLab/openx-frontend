                  ...
                  <div className="row no-padding">
                    ...
                    <div className="col-sm-12 col-md-4 mg-top-15">
                      ...
                      <div className="flex-content-60 pd-sub-text overflow-auto">
                        ...
                        Vestibulum condimentum lectus in convallis feugiat. Sed
                        vulputate fringilla felis. Aliquam ut arcu et dui
                        feugiat scelerisque eu quis diam. Mauris placerat congue
                        dui sit amet blandit. Phasellus condimentum libero vel
                        velit auctor, sit amet tincidunt velit varius. Mauris
                        lacinia porta faucibus. Fusce eu est ac eros vulputate
                        mollis in ac felis. Aenean commodo scelerisque mi sed
                        imperdiet. Donec at hendrerit nisi, eget vestibulum
                        nisi. Sed sit amet magna luctus, facilisis erat quis,
                        sagittis ligula. Aenean dignissim velit quis leo
                        consequat ultricies. Proin quis pretium justo.
                        Vestibulum at eros nisl. Fusce lobortis erat ante, eu
                        cursus sapien molestie at. Pellentesque placerat ante
                        diam, et euismod lacus dictum vel. Phasellus vitae
                        sollicitudin mi. In pulvinar eleifend convallis.
                        Suspendisse elit erat, venenatis eget ullamcorper ut,
                        laoreet iaculis nisl. Sed porta, felis id rhoncus
                        aliquet, quam ipsum pellentesque metus, in sodales quam
                        nunc vitae risus. Quisque in venenatis massa. Phasellus
                        neque risus, ornare quis nisl ultricies, ullamcorper
                        consectetur orci.
                      </div>
                      <div className="flex-content-30 ">
                        <img
                      ...
                      <div className="container no-padding">
                        <div className="row">
                          <div className="col-4 pd-sub-text overflow-auto">
                            ...
                            feugiat. Sed vulputate fringilla felis. Aliquam ut
                            arcu et dui feugiat scelerisque eu quis diam. Mauris
                            placerat congue dui sit amet blandit. Phasellus
                            condimentum libero vel velit auctor, sit amet
                          ...
                          <div className="col-4">
                            ...
                            <div className="flex-content-40 pd-sub-text overflow-auto">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Cras dapibus vulputate diam eu pretium.
                              Mauris elit orci, ultricies id fermentum vel,
                              porta et eros. Vestibulum condimentum lectus in
                              convallis feugia
                            </div>
                          </div>
                          <div className="col-4">
              ...
              <div className="col-12 mg-top-15">
                <div className="row">
                  ...
                  <div className="col-12 col-sm-4 pd-sub-text">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Cras dapibus vulputate diam eu pretium.x
                  </div>
                </div>
              </div>
              <div className="col-12 mg-top-15">
