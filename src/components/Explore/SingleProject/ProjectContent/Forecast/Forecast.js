            ...
            <div className="col-12">
                <div className="DevelopmentStage">
                    <div className="row ds-chart">
                        <div className="col-xs-1-10"><img className="ds-image" src="https://via.placeholder.com/50x50"
                                alt="placeholder" /></div>
                        <div className="col-xs-1-10">
                            <div className="ds-count">0</div>
                            <div className="ds-ball ds-full"></div>
                            <div className="ds-line"></div>
                            <div className="ds-title"><a href="#" title="Stage 0 description"
                                    style={style1}>Handshake</a></div>
                        ...
                        <div className="col-xs-1-10">
                            ...
                            <div className="ds-ball ds-full"></div>
                            <div className="ds-line"></div>
                            <div className="ds-title"><a href="#" title="Stage 3 description"
                                    style={style1}>Contracts</a></div>
                        ...
                        <div className="col-xs-1-10">
                            ...
                            <div className="ds-line"></div>
                            <div className="ds-title"><a href="#" title="Stage 5 description"
                                    style={style1}>Construction</a></div>
                        ...
                        <div className="col-xs-1-10">
                            ...
                            <div className="ds-ball ds-empty"></div>
                            <div className="ds-line"></div>
                            <div className="ds-title"><a href="#" title="Stage 6 description"
                                    style={style1}>Interconnection</a></div>
