              ...
              <div className="row mx-auto">
                ...
                <div className="col-12 col-sm-7 mx-auto mg-top-15 forecast-info">
                  ...
                  <div className="forecast-info-content">
                    ...
                    successfully funded and deployment, and the receiver is
                    making appropriate schedule. Larn more>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-sm-7 mx-auto mg-top-15 forecast-info">
                ...
                <div className="restricted-info-sub-title">
                  access restricted
                </div>
                <div className="forecast-info-content">
                  Access to this section is reserved for contract parties.
                  Either link-to-login you are not logged in, or you don’t have
                  access credentials.
                </div>
              </div>
