...
import {validateAction, validateEntityAction} from "../../../Profile/store/actions";
...
class Dashboard extends Component {
	...
	componentDidMount = () => {
		this.props.fetchDeveloper(Storage.get("username"));
	};
						...
						<div className="row">
							<div className="col-sm-6 col-lg-3 ">
								<SummaryCards
									title="your profile"
									items={[
										{value: developer.U.Name, desc: 'beneficiary name'},
                        ...
                        <div className="dropdown-wrapper">
                            <div className="details-container">
                                ...
                                <div className="container">
                                    ...
                                    <DetailContainer
                                        icon={IconWallet}
                                        title={"Carbon & Climate Certificates (****" + developer.U.SecondaryWallet.PublicKey.slice(-5) + ")"}
                                        titleLink={'#'}
                                        action={'0'}
                                        actionLink={"https://testnet.steexp.com/account/" + developer.U.SecondaryWallet.PublicKey}
                                    />
                                    <DetailContainer
                                        icon={IconContractor}
                                        title={"Carbon & Climate Certificates (****" + developer.U.StellarWallet.PublicKey.slice(-5) + ")"}
                                        titleLink={"https://ropsten.etherscan.io/address/" + developer.U.StellarWallet.PublicKey}
                                        action={'0'}
...
const mapStateToProps = state => ({
	developer: state.profile.entity.items,
	loading: state.profile.entity.isLoading,
	authorized: state.profile.entity.items.Developer,
});

const mapDispatchToProps = dispatch => ({
	fetchDeveloper: (username) => dispatch(validateEntityAction(username))
});
