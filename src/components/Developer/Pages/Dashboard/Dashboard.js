          ...
          <div className="title-container -border">
            <div className="container">
              <h3 className="container-title">
                You have not registered as a developer
              </h3>
            </div>
          </div>
        </div>
            ...
            <div className="row">
                ...
                <SummaryCards
                  ...
                  items={[
                    ...
                    },
                    {
                      value:
                        developer["Your Profile"] &&
                        developer["Your Profile"]["Active Projects"],
              ...
              <div className="col-sm-6 col-lg-3 ">
                <SummaryCards
                  ...
                  items={[
                    {
                      value:
                        developer["Your Energy"] &&
                        developer["Your Energy"]["Total in Current Period"],
                      desc: "TOTAL IN CURRENT PERIOD"
                    },
                    {
                      value:
                        developer["Your Energy"] &&
                        developer["Your Energy"]["All Time"],
                      desc: "ALL TIME"
                    }
                  ]}
              ...
              <div className="col-sm-6 col-lg-3 ">
                <SummaryCards
                  ...
                  items={[
                    {
                      value: developer["Your Wallet"]
                        ? developer["Your Wallet"]["Project Wallet Balance"]
                        : "$0",
                      desc: "PROJECT WALLET BALANCE"
                    },
                    {
                      value: developer["Your Wallet"]
                        ? developer["Your Wallet"]["Auto Reload"]
                        : "Inactive",
                      desc: "AUTO RE-LOAD"
                    }
                  ]}
              ...
              <div className="col-sm-6 col-lg-3 ">
                <SummaryCards
                  ...
                  items={[
                    {
                      value: developer["Notifications & Actions"]
                        ? developer["Notifications & Actions"]["Notification"]
                        : "None",
                      desc: "NOTIFICATION"
                    },
                    {
                      value: developer["Notifications & Actions"]
                        ? developer["Notifications & Actions"][
                            "Actions Required"
                          ]
                        : "None",
...
const mapDispatchToProps = dispatch => ({
  fetchDeveloperDB: (entity, username) =>
