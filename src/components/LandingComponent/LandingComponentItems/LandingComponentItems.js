...
const landingComponentItems = props => (
  <div className="content">
    <div className="justify-content-around row items">
      ...
      <LandingItem url={ROUTES.DEVELOPER} title="Originate" imageUrl="https://s3.amazonaws.com/cz-public-images/openx/Landing+Page+2.png" diffUrl="ACCESS THE ORIGINATOR ENGINE >"/>
    </div>
  </div>
);
