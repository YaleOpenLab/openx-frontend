...
const Sweep = ({ account, showMessage }) => {
  ...
  return (
    <div>
      ...
      <StyledDescription>
        You can sweep funds to another account using the user interface below or
        by using the rescue CLI function
      </StyledDescription>
      ...
      <StyledSeparator noBorder size={3} />
      <StyledError>
        This will move all of your funds to the destination address your
        provide, which has to be an existing Stellar based account{" "}
      </StyledError>
      <StyledActions>
        <Button
          style={{ width: 214 }}
...
export default connect(mapStateToProps, mapDispatchToProps)(Sweep);
