    ...
    <div className="ProfilePageContainer">
      <div className="row">
        <div className="col-12 col-md-10 col-lg-8 mx-auto margin-bottom">
          ...
          <StyledText>
            <Highlight>
              Define your user profiles and assign them accounts.{" "}
            </Highlight>
            ‘User Profile’ refers to the type of user action by which you engage
            in the platform. This relates to whether you are acting as an
            Investor, Developer or Receiver, and which Entity is being used for
            each one.
          </StyledText>
...
export default connect(mapStateToProps, mapDispatchToProps)(MainFundsPage);
