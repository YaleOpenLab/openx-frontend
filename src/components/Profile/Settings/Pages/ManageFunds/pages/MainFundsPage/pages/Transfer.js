...
const Transfer = ({account, showMessage}) => {
    ...
    return (
        <div>
            ...
            <Select placeholder='Select Option' value={from} items={SelectItems} onChange={(e) => handleSelectChange(e, 'from')}/>
            <StyledDescription>
                Where?
            </StyledDescription>
            <Select placeholder='Select Option'  value={to} items={SelectItems} onChange={(e) => handleSelectChange(e, 'to')}/>
            <StyledDescription>
                How Much?
            </StyledDescription>
