...
const Seed = ({ account, showMessage }) => {
  ...
  return (
    <div>
      <StyledDescription>
        Send 2/3 of these to another account in order to recover your seed at a
        later date
      </StyledDescription>
      <StyledSeparator size={3} />
      <Input
        placeholder="RANDOM STRING HERE"
        value={account.RecoveryShares[0]}
        disabled={true}
      />
      <Input
        placeholder="RANDOM STRING HERE"
        value={account.RecoveryShares[1]}
        disabled={true}
      />
      <Input
        placeholder="RANDOM STRING HERE"
        value={account.RecoveryShares[2]}
        disabled={true}
      />
      <StyledSeparator size={3} />
      <Formik
      ...
      >
        {({ errors, touched }) => (
          <Form className="solar-form">
            <StyledDescription>Fill email addresses:</StyledDescription>
            <StyledSection>
              <Field
                type="text"
