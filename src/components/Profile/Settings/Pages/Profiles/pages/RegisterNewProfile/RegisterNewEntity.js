...
import {Highlight, StyledHeader, StyledSeparator, StyledText} from "../../../styles";
...
const RegisterNewEntity = withRouter(({account, loading, registerAccount, match, isRecipient, isInvestor}) => {
			...
			<div className="Register">
				<div className="row">
					<div className="col-12 col-md-10 col-lg-8 mx-auto margin-bottom">
						<StyledHeader>Proceed to register as a(n) {match.params.userType}?</StyledHeader>
						<StyledText>
							<Highlight>
							{isRecipient && !isInvestor && "You are already registered as an recipient, do you still want to create a new profile?"}
							{!isRecipient && isInvestor && "You are already registered as an investor, do you still want to create a new profile?"}
							{isRecipient && isInvestor && "You already have beneficiary and investor accounts"}
							</Highlight>
						</StyledText>
