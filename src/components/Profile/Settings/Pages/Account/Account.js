      ...
      <div className="row">
        <div className="col-12 col-md-10 col-lg-8 mx-auto ">
          ...
          <div className="component-box-text">
            <span className="--highlight">Your profile as an individual.</span>{" "}
            Everyone operating through the opensolar platform needs to register
            as an individual first. To register as an ‘organisation’ that you
            operate on behalf of, go to ‘Entity Profile.’
          </div>
        </div>
        <div className="col-12 col-md-10 col-lg-8 mx-auto ">
              ...
              <div className="col-12 col-md-10 col-lg-8 mx-auto ">
                ...
                <div className="component-box-text">
                  <span className="--highlight">
                    How will you use the opensolar platform?
                  </span>
                </div>
                <div className="component-box-text">
                  This will create accounts and dashboard associated to your
                  Profile and Entity. Only select those that you are sure you
                  will use. You can select multiple options.
                </div>
