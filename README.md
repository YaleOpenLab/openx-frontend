...
This repo is intended to house the code for the frontend platform live at https://www.openx.solar. The frontend is written in React and was bootstrapped using the [create React App](https://github.com/facebook/create-react-app).
